...
enum class DisplayTheme(val id: String, val label: String) {
    ...
    PLAY("play", "Шалость"),
    FOREST("forest", "Лес"),
    AUTUMN_FOREST("autumn-forest", "Осенний лес"),
    MOUNTAINS("mountains", "Горы"),
    SEA("sea", "Море"),
    SPACE("space", "Космос"),
    PETERSBURG("petersburg", "Петербург"),
    PETERSBURG_STREETS("petersburg-streets", "Улицы Петербурга"),
    ORANIENBAUM("oranienbaum", "Ораниенбаум"),
    PETERHOF("peterhof", "Петергоф"),
    ROME("rome", "Рим"),
    FLORENCE("florence", "Флоренция"),
    VENICE("venice", "Венеция"),
    ITALY_SUNSET("italy-sunset", "Итальянский закат"),
    PALACE_STUDY("palace-study", "Дворцовый кабинет"),
    RUS("rus", "Русский узор"),
    GZHEL("gzhel", "Гжель"),
    SOVIET_CARPET("soviet-carpet", "Советский ковёр"),
