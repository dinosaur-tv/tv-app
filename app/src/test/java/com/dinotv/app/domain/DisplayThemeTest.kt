...
class DisplayThemeTest {
    ...
    fun `resolves every server theme identifier`() {
        ...
        assertEquals(DisplayTheme.AUTUMN_FOREST, DisplayTheme.fromId("autumn-forest"))
        ...
        assertEquals(DisplayTheme.PETERSBURG_STREETS, DisplayTheme.fromId("petersburg-streets"))
        assertEquals(DisplayTheme.ORANIENBAUM, DisplayTheme.fromId("oranienbaum"))
        assertEquals(DisplayTheme.PETERHOF, DisplayTheme.fromId("peterhof"))
        ...
        assertEquals(DisplayTheme.ITALY_SUNSET, DisplayTheme.fromId("italy-sunset"))
        assertEquals(DisplayTheme.PALACE_STUDY, DisplayTheme.fromId("palace-study"))
        assertEquals(DisplayTheme.RUS, DisplayTheme.fromId("rus"))
        assertEquals(DisplayTheme.GZHEL, DisplayTheme.fromId("gzhel"))
        assertEquals(DisplayTheme.SOVIET_CARPET, DisplayTheme.fromId("soviet-carpet"))
